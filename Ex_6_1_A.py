'''These are the sixth exercise problems. Please return your Python code.'''
'''All the code written during the lectures can be again found under the same link
as the lecture notes and recordings, inside the folder "Codes".'''

'''1. Let us consider the file "Collision_simulation_v1.py". At the moment, collision
recognition and collision response work adequately.'''

'''a) One of the major problems is that the user can create a new object anywhere, even
inside walls or other objects. Modify the code so that this is not possible.'''
...
while running:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONUP and event.button == 1:
            ...
            #adding a particle after checking the collision is in the wall or with other particle
